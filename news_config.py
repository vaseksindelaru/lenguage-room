...
DEFAULT_NEWS_CONFIG = {
    ...
    "sources": [
        {"id": "the-decoder", "name": "The Decoder", "type": "rss",
         "url": "https://the-decoder.com/feed/",
         "enabled": True,  "max_items_per_source": 5,
         "keywords_filter": "", "exclude_keywords": "", "language": "en"},
        {"id": "marktechpost", "name": "MarkTechPost", "type": "rss",
         "url": "https://marktechpost.com/feed/",
         "enabled": True,  "max_items_per_source": 5,
         "keywords_filter": "", "exclude_keywords": "", "language": "en"},
        {"id": "arstechnica", "name": "Ars Technica", "type": "rss",
         "url": "https://feeds.arstechnica.com/arstechnica/index",
         "enabled": True,  "max_items_per_source": 5,
         "keywords_filter": "", "exclude_keywords": "", "language": "en"},
        {"id": "singularitynet", "name": "SingularityNET", "type": "rss",
         "url": "https://singularitynet.io/feed/",
         "enabled": True,  "max_items_per_source": 5,
         "keywords_filter": "", "exclude_keywords": "", "language": "en"},
        {"id": "huggingface", "name": "Hugging Face Blog", "type": "rss",
         "url": "https://huggingface.co/blog/rss.xml",
         "enabled": True,  "max_items_per_source": 5,
         "keywords_filter": "", "exclude_keywords": "", "language": "en"},
        {"id": "ai-weekly", "name": "AI Weekly", "type": "rss",
